...
It's often very hard to read continuous color scales. Remember how we'd previously used a y-axis that used a binned scale? That might not be very useful for case counts, but it could potentially be useful for making our color scale more readable.
...
I won't spend much time on this section. I only want to note that there are similar scales for other aesthetics, and reiterate that every aesthetic must be represented by some scale. ggplot is usually pretty good about picking defaults that fit our usual assumptions, but just remember that you can take complete control at any time, for any aesthetic.
